...
# Compiled at: 2014-09-24 10:34:49
import BigWorld
import Math
import ResMgr
import Pixie
...
class WarplaneActivity(IMapActivity):
    ...
    def __playSound(self):
        ...
        if soundName != '':
            try:
                self.__sound = SoundGroups.g_instance.playSound(self.__model, soundName)
...
def _createActivity(typeName):
    if typeName == 'warplane':
        ...
        return ScenarioActivity() if typeName == 'scenario' else None
