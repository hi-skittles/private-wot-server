...
# Compiled at: 2015-03-18 09:45:18
import constants
import json
import hashlib
import BigWorld
...
class ConnectionManager(Singleton):
    ...
    @property
    def areaID(self):
        return self.__host.areaID if not self.isDisconnected() else None

    @property
    def loginName(self):
        return self.__loginName if not self.isDisconnected() else None
