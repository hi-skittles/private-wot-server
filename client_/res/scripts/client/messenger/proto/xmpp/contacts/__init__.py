...
# Compiled at: 2015-03-13 05:46:08
...
class ContactsManager(ClientEventsHandler):
    ...
    def __checkRosterSize(self):
        ...
        return ClientIntLimitError(LIMIT_ERROR_ID.MAX_ROSTER_ITEMS, CONTACT_LIMIT.ROSTER_MAX_COUNT) if length >= CONTACT_LIMIT.ROSTER_MAX_COUNT else None
