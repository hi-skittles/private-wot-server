...
# Compiled at: 2015-01-25 07:44:28
import cPickle
...
class ClientUnitMgr(object):
    ...
    def setDevMode(self, isDevMode=True, unitIdx=0):
        return self.__doUnitCmd(CLIENT_UNIT_CMD.SET_UNIT_DEV_MODE, self.id, unitIdx, int(isDevMode)) if constants.IS_DEVELOPMENT else None
