...
# Compiled at: 2015-01-10 13:35:46
...
class DirectionCtx(FortRequestCtx):
    ...
    def getRequestType(self):
        return FORT_REQUEST_TYPE.OPEN_DIRECTION if self.__isOpen else FORT_REQUEST_TYPE.CLOSE_DIRECTION
...
class BuildingCtx(FortRequestCtx):
    ...
    def getRequestType(self):
        return FORT_REQUEST_TYPE.ADD_BUILDING if self.__isAdd else FORT_REQUEST_TYPE.DELETE_BUILDING
...
class OrderCtx(FortRequestCtx):
    ...
    def getRequestType(self):
        return FORT_REQUEST_TYPE.ADD_ORDER if self.__isAdd else FORT_REQUEST_TYPE.ACTIVATE_ORDER
