...
# Compiled at: 2014-11-17 03:02:55
...
class HistoricalBattlesListWindow(PrequeueWindow, HistoricalBattlesListWindowMeta, Notifier):
    ...
    def updateVehiclesList(self):
        ...
        def sortFunction(a, b):
            ...
            if a.isReadyToFight and not b.isReadyToFight:
                return -1
            return 1 if not a.isReadyToFight and b.isReadyToFight else 0
    ...
    def _getSelectedPriceIndex(self, prices):
        return self.priceIndex if self.priceIndex is not None else len(prices) - 1
