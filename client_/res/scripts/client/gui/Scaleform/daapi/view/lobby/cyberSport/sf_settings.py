...
# Compiled at: 2015-01-26 11:31:24
...
def getViewSettings():
    ...
    return [GroupedViewSettings(VIEW_ALIAS.CYBER_SPORT_SEND_INVITES_WINDOW, CyberSportSendInvitesWindow, 'prbSendInvitesWindow.swf', ViewTypes.WINDOW, '', VIEW_ALIAS.CYBER_SPORT_SEND_INVITES_WINDOW, ScopeTemplates.DEFAULT_SCOPE),
     GroupedViewSettings(CYBER_SPORT_ALIASES.CYBER_SPORT_WINDOW_PY, CyberSportMainWindow, CYBER_SPORT_ALIASES.CYBER_SPORT_WINDOW_UI, ViewTypes.WINDOW, '', CYBER_SPORT_ALIASES.CYBER_SPORT_WINDOW_PY, ScopeTemplates.DEFAULT_SCOPE),
     ...
     GroupedViewSettings(CYBER_SPORT_ALIASES.CYBER_SPORT_STATIC_PROFILE_PY, ClubProfileWindow, CYBER_SPORT_ALIASES.CYBER_SPORT_STATIC_PROFILE_UI, ViewTypes.WINDOW, '', None, ScopeTemplates.DEFAULT_SCOPE),
     GroupedViewSettings(CYBER_SPORT_ALIASES.STATIC_FORMATION_INVITES_AND_REQUESTS_PY, StaticFormationInvitesAndRequestsWindow, CYBER_SPORT_ALIASES.STATIC_FORMATION_INVITES_AND_REQUESTS_UI, ViewTypes.WINDOW, '', None, ScopeTemplates.DEFAULT_SCOPE),
