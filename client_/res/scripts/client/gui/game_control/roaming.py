...
# Compiled at: 2014-11-25 03:54:28
import BigWorld
...
class RoamingController(Controller):
    ...
    def getHomeCenterID(self):
        return self.__roamingSettings.homeCenterID if self.__roamingSettings is not None else -1

    def getCurrentCenterID(self):
        return self.__roamingSettings.curCenterID if self.__roamingSettings is not None else -1

    def getRoamingCenters(self):
        return self.__roamingSettings.servers if self.__roamingSettings is not None else []
