...
# Compiled at: 2014-12-01 12:14:53
from debug_utils import LOG_DEBUG, LOG_WARNING, LOG_ERROR

class CLIENT_LOG_AREA(object):
    GLOOX_SOURCE, GLOOX_XML, PY_WRAPPER, CONNECTION, LOGIN, TOKEN, ROSTER, GROUP, SETTINGS, GENERIC, SYNC, BLOCK_LIST, RESOURCE, SUBSCRIPTION = range(14)
