...
# Compiled at: 2015-03-19 02:47:29
...
class ProjectileMover(object):
    ...
    def __calcModelAutoScale(self, modelPos):
        ...
        return Math.Vector3(1, 1, 1) if distance <= ProjectileMover.__AUTO_SCALE_DISTANCE or not isinstance(inputHandler.ctrl, SniperControlMode) else Math.Vector3(1, 1, 1) * distance / ProjectileMover.__AUTO_SCALE_DISTANCE
