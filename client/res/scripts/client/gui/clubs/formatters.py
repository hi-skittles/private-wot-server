...
# Compiled at: 2015-04-09 11:14:00
...
class InvitesSysMsgFormatter(object):
    ...
    def getErrorSysMsg(self):
        return _sysMsg('clubs/request/success/invites/sent/names/error', names=', '.join(self._errorNames)) if len(self._errorNames) > 1 else None
