...
# Compiled at: 2015-02-03 06:55:52
...
class TankmanSkill(GUIItem):
    ...
    @property
    def userName(self):
        return i18n.makeString('#item_types:tankman/skills/brotherhood_female') if self.name == 'brotherhood' and self.isFemale else getSkillUserName(self.name)

    @property
    def description(self):
        return i18n.makeString('#item_types:tankman/skills/brotherhood_female_descr') if self.name == 'brotherhood' and self.isFemale else getSkillUserDescription(self.name)
