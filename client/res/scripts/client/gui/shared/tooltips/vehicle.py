...
# Compiled at: 2014-12-24 09:01:26
import BigWorld
import math
import constants
...
class VehicleStatusField(ToolTipDataField):
    ...
    def _getValue(self):
        ...
        return self.__getTechTreeVehicleStatus(config, vehicle) if config.node is not None else self.__getVehicleStatus(config.showCustomStates, vehicle)
