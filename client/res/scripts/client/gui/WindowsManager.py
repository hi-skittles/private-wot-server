...
# Compiled at: 2014-11-17 08:42:59
import BigWorld
import Event
import constants
import BattleReplay
...
class WindowsManager(object):
    ...
    def getHangarSpace(self):
        return None if not hasattr(self.__window, 'currentInterface') or not self.__window.currentInterface == 'hangar' else self.__window.space
