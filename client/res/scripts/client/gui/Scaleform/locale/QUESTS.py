...
class QUESTS(object):
    ...
    PERSONAL_SEASONS_SLOTS_NOACTIVESLOTS = '#quests:personal/seasons/slots/noActiveSlots'
    ...
    TILECHAINSVIEW_HIDECOMPLETEDTASKS_TEXT = '#quests:tileChainsView/hideCompletedTasks/text'
    ...
    QUESTSCHAINPROGRESSVIEW_STATUS_EXCELLENTDONE = '#quests:QuestsChainProgressView/status/excellentDone'
    QUESTSCHAINPROGRESSVIEW_STATUS_DONE = '#quests:QuestsChainProgressView/status/done'
    ...
    QUESTTASKDETAILSVIEW_TASKDESCRIPTION_MAXTASKSTAKEN = '#quests:QuestTaskDetailsView/taskDescription/maxTasksTaken'
