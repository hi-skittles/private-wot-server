...
# Compiled at: 2015-03-25 02:05:57
...
class VehicleMarkersManager(Flash):
    ...
    def __getVehicleDamageType(self, attackerID):
        ...
        return VehicleMarkersManager.DAMAGE_TYPE.FROM_ENEMY if entityName == PLAYER_ENTITY_NAME.enemy else VehicleMarkersManager.DAMAGE_TYPE.FROM_UNKNOWN
...
def _markerComparator(x1, x2):
    ...
    if x1Index < x2Index:
        return -1
    return 1 if x1Index > x2Index else 0
