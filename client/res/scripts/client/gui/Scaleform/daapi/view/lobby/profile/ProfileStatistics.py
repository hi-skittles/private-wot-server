...
# Compiled at: 2015-03-11 10:20:06
import BigWorld
...
class ProfileStatistics(ProfileSection, ProfileStatisticsMeta):
    ...
    def __getFortAvgLoot(self, targetData, totalLootValue):
        ...
        return BigWorld.wg_getNiceNumberFormat(totalLootValue / battlesCount) if battlesCount > 0 else ProfileUtils.UNAVAILABLE_VALUE
