...
# Compiled at: 2015-03-26 12:16:59
import BigWorld
...
class ClubSummaryView(StaticFormationSummaryViewMeta, ClubPage):
    ...
    def getSeasonText(self):
        return text_styles.alert(icons.noSeason() + _ms(CYBERSPORT.STATICFORMATIONSUMMARYVIEW_NOSEASON)) if not isSeasonInProgress() else None
