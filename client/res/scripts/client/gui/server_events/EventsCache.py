...
# Compiled at: 2015-02-20 06:19:27
import math
import sys
import zlib
...
class _EventsCache(object):
    ...
    def getEventBattles(self):
        ...
        return EventBattles(battles.get('vehicleTags', set()), battles.get('vehicles', []), bool(battles.get('enabled', 0)), battles.get('arenaTypeID')) if len(battles) else None
