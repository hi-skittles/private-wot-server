...
# Compiled at: 2011-06-20 07:18:55
import time
...
class OutOffers(object):
    ...
    def get(self, offerID):
        ...
        return _makeOutOffer(offer) if offer is not None else None

    def getExt(self, offerID, default=None):
        outExt = self.__data.get('outExt')
        return default if outExt is None else outExt.get(offerID, default)
    ...
    def inventorySlots(self):
        ...
        for offer in self.__data['out'].itervalues():
            ...
            if srcWareKind == SRC_WARE_TANKMAN:
                numTmen += 1
...
class InOffers(object):
    ...
    def get(self, offerID):
        ...
        return _makeInOffer(offer) if offer is not None else None
