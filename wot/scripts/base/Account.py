...
class Account(BigWorld.Proxy):
    def __init__(self):
        ...
        # temporary fix for no-name accounts
        if len(self.name) <= 0:
    ...
    def setRestriction(self, MAILBOX, INT32, UINT8, STRING, UINT32, UINT32_2, UINT32_3, UINT16, STRING_2, INT32_2, UINT32_4):
        DEBUG_MSG('Server.setRestriction', MAILBOX, INT32, UINT8, STRING, UINT32, UINT32_2, UINT32_3, UINT16, STRING_2, INT32_2, UINT32_4)
        pass
    ...
    def restoreAccountFromPoint(self, MAILBOX, INT32, UINT64, PYTHON, ARRAY, UINT64_2, UINT32, UINT64_3, UINT64_4, INT32_2, UINT32_2):
        # ARRAY is a list of UINT64
        DEBUG_MSG('Server.restoreAccountFromPoint', MAILBOX, INT32, UINT64, PYTHON, ARRAY, UINT64_2, UINT32, UINT64_3, UINT64_4, INT32_2, UINT32_2)
        pass
    ...
    def receiveClanMemberInfo(self, DB_ID, DB_ID_2, STRING, STRING_2, STRING_3, STRING_4, DB_ID_3, INT32, INT32_2, STRING_5, STRING_6):
        DEBUG_MSG('Server.receiveClanMemberInfo', DB_ID, DB_ID_2, STRING, STRING_2, STRING_3, STRING_4, DB_ID_3, INT32, INT32_2, STRING_5, STRING_6)
        pass
    ...
    def requestFortPublicInfo(self, INT32, INT8, STRING, INT16, INT8_2, INT8_3, INT8_4, INT8_5, INT8_6, INT8_7, INT8_8, INT32_2, INT8_9, INT8_10, INT32_3, INT8_11, INT32_4, INT8_12, INT32_5, BOOL, ARRAY):
        # ARRAY is a list of INT64
        # Exposed tag
        DEBUG_MSG('Server.requestFortPublicInfo', INT32, INT8, STRING, INT16, INT8_2, INT8_3, INT8_4, INT8_5, INT8_6, INT8_7, INT8_8, INT32_2, INT8_9, INT8_10, INT32_3, INT8_11, INT32_4, INT8_12, INT32_5, BOOL, ARRAY)
        pass
